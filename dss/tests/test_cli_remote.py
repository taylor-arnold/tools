...
class TestPushCommand:
    ...
    def test_push_success(self, working_directory: Path, cli_runner: CliRunner, manifest_file: Path, test_file: Path, mock_subprocess):
        ...
        assert "testuser@test.example.com:/data/test/test-uuid-1234/test_file.txt" in rsync_call[0][0]

    def test_push_all_files(self, working_directory: Path, cli_runner: CliRunner, manifest_file: Path, mock_subprocess):
    ...
    def test_push_missing_manifest(self, working_directory: Path, cli_runner: CliRunner):
    ...
    def test_push_missing_remote_config(self, working_directory: Path, cli_runner: CliRunner):
    ...
    def test_push_missing_manifest_uuid(self, working_directory: Path, cli_runner: CliRunner, test_file: Path):
    ...
    def test_push_nonexistent_file(self, working_directory: Path, cli_runner: CliRunner, manifest_file: Path, mock_subprocess):
    ...
    def test_push_mkdir_failure(self, working_directory: Path, cli_runner: CliRunner, manifest_file: Path, test_file: Path, mock_subprocess):
    ...
    def test_push_rsync_failure(self, working_directory: Path, cli_runner: CliRunner, manifest_file: Path, test_file: Path, mock_subprocess):
...
class TestPullCommand:
    ...
    def test_pull_success(self, working_directory: Path, cli_runner: CliRunner, manifest_file: Path, mock_subprocess):
    ...
    def test_pull_missing_remote_file(self, working_directory: Path, cli_runner: CliRunner, manifest_file: Path, mock_subprocess):
    ...
    def test_pull_all_files(self, working_directory: Path, cli_runner: CliRunner, mock_subprocess):
    ...
    def test_pull_custom_remote(self, working_directory: Path, cli_runner: CliRunner, mock_subprocess):
    ...
    def test_pull_missing_manifest_uuid(self, working_directory: Path, cli_runner: CliRunner):
